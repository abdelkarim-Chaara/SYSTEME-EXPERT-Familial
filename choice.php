                ...
                <div class="wizard-navigation">
                            ...
                            <div class="wizard-footer">
                                <div class="pull-right">
                                      <input type="button" style="width:300px" onclick="location.href = 'espacehomme.php';" class="btn btn-next btn-fill btn-danger btn-wd" name="finish" value="Aptitude d'avoir des enfance">
                                  </div>
                                  <div class="pull-left">
                                  
                                  	
                                 
                                      <input type="button" style="width:300px" onclick="location.href = 'type1.php';" class="btn btn-previous btn-fill btn-default btn-wd" name="Re-Test" value="Type Personnalité">
